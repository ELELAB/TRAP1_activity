...
class MyModel(automodel):
    def select_atoms(self):
        ...
        return selection(self.residue_range('42:', '47:'), self.residue_range('130:', '135:'), self.residue_range('260:', '269:'), self.residue_range('457:', '481:'), self.residue_range('507:', '511:'), self.residue_range('529:', '546:'), self.residue_range('608:', '611:'))
...
a = MyModel(env,
            alnfile  = 'chainA.ali', # alignment filename
            knowns   = ('4ipe_chainA_MOD'),     # codes of the templates
            sequence = 'TRAP1_chainA')               # code of the target
